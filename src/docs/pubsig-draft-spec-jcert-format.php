...
1) The key is \'flattened out\' with each key\'s full path and value (encased in double quotes) on each line.
   If a key value is a numerical array (list) then numbers are used for the keys of that value ([0] [1] [2] etc.).
   e.g. To calculate the signature of the [jcert][certificate] key:
   [jcert][certificate][name] = "..."
   [jcert][certificate][domain] = "..."
   [jcert][certificate][website] = "..."
   [jcert][certificate][repository_url] = "..."
   [jcert][certificate][json_rpc_url] = "..."
   [jcert][certificate][avatar] = "..."
   [jcert][certificate][timestamp] = "..."
